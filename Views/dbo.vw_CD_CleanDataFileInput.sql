...
CREATE view [dbo].[vw_CD_CleanDataFileInput] as 
(
...
where (cdq.ContactField = 'PrimaryAddress')-- or p.dbLastUpdated > DATEADD(hour, -12, getdate()))
...
where 1=1 and cdq.ContactField = 'Address2'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'Address3'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'HomePhone'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'CellPhone'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'BusinessPhone'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'Fax'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'OtherPhone'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'EvEmail'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'PersonalEmail'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'BusinessEmail'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'OtherEmail'
...
from dbo.patron__c p
inner join dbo.CD_ProcessQueue cdq on p.Patron = cdq.SourceContactId
where 1=1 and cdq.ContactField = 'FullName'
