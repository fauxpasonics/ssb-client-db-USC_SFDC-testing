...
CREATE view [dbo].[vw_CD_CleanDataFileInput_20140303] as 
(
...
from src.Patron__c p inner join (select distinct patron_id__c from [dbo].[Transactions__c]) t on p.patron = t.Patron_ID__c
