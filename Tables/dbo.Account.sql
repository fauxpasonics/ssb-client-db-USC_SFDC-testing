...
GO
ALTER TABLE [dbo].[Account] ADD CONSTRAINT [PK_Accountstg_1] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_ACCT_ID])
GO
CREATE NONCLUSTERED INDEX [IDX_dboAccount_IsBusiAccount_AcctGUID_CRMID] ON [dbo].[Account] ([IsBusinessAccount]) INCLUDE ([salesforce_ID], [SSB_CRMSYSTEM_ACCT_ID])
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Account] ON [dbo].[Account] ([salesforce_ID])
GO
