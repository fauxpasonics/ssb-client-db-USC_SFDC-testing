...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__User__CopyLoadDa__1E6F845E] DEFAULT (getdate())
)
GO
ALTER TABLE [ProdCopy].[User] ADD CONSTRAINT [PK_User_id] PRIMARY KEY CLUSTERED  ([Id])
GO
