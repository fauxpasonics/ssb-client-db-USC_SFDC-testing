CREATE TABLE [dbo].[SFDC_TransOdet]
(
[SEASON] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ORDER_LINE_ID] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__SFDC_Tran__CopyL__45F365D3] DEFAULT (getdate()),
[SourceSystem] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CurrentHash] [varbinary] (max) NULL
)
GO
CREATE NONCLUSTERED INDEX [SFDC_TransOdet_Customer] ON [dbo].[SFDC_TransOdet] ([CUSTOMER])
GO
CREATE NONCLUSTERED INDEX [SFDC_TransOdet_SeasonI_PT] ON [dbo].[SFDC_TransOdet] ([SEASON], [I_PT])
GO
CREATE NONCLUSTERED INDEX [SFDC_TransOdet_SeasonItem] ON [dbo].[SFDC_TransOdet] ([SEASON], [ITEM])
GO
