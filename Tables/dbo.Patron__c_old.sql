CREATE TABLE [dbo].[Patron__c_old]
(
[Suffix] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[IsBusinessAccount] [bit] NULL CONSTRAINT [DF_Patron__c_IsBusinessAccount] DEFAULT ((0)),
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20141209-213016] ON [dbo].[Patron__c_old] ([ContactId])
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20141209-212946] ON [dbo].[Patron__c_old] ([Patron])
GO
