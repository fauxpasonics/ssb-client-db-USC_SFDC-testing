...
[IsMerged] [bit] NOT NULL CONSTRAINT [DF_CD_CleanDataOutput_Merged] DEFAULT ((0))
)
GO
ALTER TABLE [src].[CD_CleanDataResult] ADD CONSTRAINT [PK_CleanDataResultId] PRIMARY KEY CLUSTERED  ([CleanDataResultId])
GO
