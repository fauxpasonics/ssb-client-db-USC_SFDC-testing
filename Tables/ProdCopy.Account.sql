...
[CreatedById] [varchar] (18) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[LastModifiedDate] [datetime] NULL,
[LastModifiedById] [varchar] (18) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_account_createdbyid] ON [ProdCopy].[Account] ([CreatedById])
GO
CREATE NONCLUSTERED INDEX [ix_account_isdeleted_createdbyid_include] ON [ProdCopy].[Account] ([IsDeleted], [CreatedById]) INCLUDE ([CreatedDate], [Id], [IsPersonAccount], [LastActivityDate], [LastModifiedById], [LastModifiedDate], [Name], [OwnerId])
GO
CREATE NONCLUSTERED INDEX [ix_account_isdeleted_id] ON [ProdCopy].[Account] ([IsDeleted], [Id]) INCLUDE ([CreatedById], [CreatedDate], [IsPersonAccount], [LastActivityDate], [LastModifiedById], [LastModifiedDate], [Name], [OwnerId])
GO
CREATE NONCLUSTERED INDEX [ix_account_lastmodifiedbyid] ON [ProdCopy].[Account] ([LastModifiedById])
GO
CREATE NONCLUSTERED INDEX [ix_account_ownerid] ON [ProdCopy].[Account] ([OwnerId])
GO
CREATE NONCLUSTERED INDEX [IDX_ProdCopy_Account_ACCTGUID] ON [ProdCopy].[Account] ([SSB_CRMSYSTEM_ACCT_ID__c])
GO
ALTER TABLE [ProdCopy].[Account] ADD CONSTRAINT [fk_account_user_createdbyid_id] FOREIGN KEY ([CreatedById]) REFERENCES [ProdCopy].[User] ([Id])
GO
ALTER TABLE [ProdCopy].[Account] ADD CONSTRAINT [fk_account_user_lastmodifiedbyid_id] FOREIGN KEY ([LastModifiedById]) REFERENCES [ProdCopy].[User] ([Id])
GO
ALTER TABLE [ProdCopy].[Account] ADD CONSTRAINT [fk_account_user_ownerid_id] FOREIGN KEY ([OwnerId]) REFERENCES [ProdCopy].[User] ([Id])
GO
