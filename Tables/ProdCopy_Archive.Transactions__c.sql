CREATE TABLE [ProdCopy_Archive].[Transactions__c]
(
...
[Parking_Year__c] [nvarchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Sport__c] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Lot_Number__c] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Transaction_Type__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [idx_Transactions__c] ON [ProdCopy_Archive].[Transactions__c] ([Id]) INCLUDE ([BackupDate])
GO
